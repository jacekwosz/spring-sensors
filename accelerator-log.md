...
```json
{
  ...
  "publisherRepository" : "hoarbor.superfast.arp/tap/supply-chain/spring-sensors-publisher",
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->hoarbor.superfast.ar...(truncated)]
